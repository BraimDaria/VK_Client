...
//  VK_Client
//
//  Created by  Daria on 21.10.2022.
//
...
@IBDesignable class AvatarView: UIView {
    ...
    let avatarImage: UIImageView = UIImageView(image: UIImage(systemName: "users"))

    
    func setupAvatarView(){
        frame = CGRect(x: 10, y: frame.midY-25, width: 80, height: 80)
